	...
	<div class="article">
		...
		<div class="btns">
		  ...
		  <el-input 
			...
			<el-button class="add" size='mini' @click='toAddArticle' type="primary">添加</el-button>
			<el-button size='mini' @click='batchDeleteArticles' type="primary">批量删除</el-button>
		</div>
		<!-- 按钮区结束 -->
		<!-- 数据区 -->
		<!-- {{params}} -->
		...
		<div class="article_tbl" v-loading="loading">
			<el-table size="mini" :data="articles" border style="width: 100%" @selection-change="handleSelectionChange">
				<el-table-column
		      type="selection"
		      width="55"
		      align='center'>
		...
		<el-dialog fullscreen :title="articleDialog.title" :visible.sync="articleDialog.visible">
		  ...
		  <el-form ref='articleForm' :model="articleDialog.form" size='small' :rules="rules" >
		    ...
		    <el-form-item label="缩略图" label-width="120px">
					<el-upload
					  action="http://39.108.80.32:8099/manager/file/upload"
